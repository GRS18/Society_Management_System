  ...
  return (
    <div className="container mt-4">
      ...
      <ul className="nav nav-tabs" id="settingsTabs" role="tablist">
        <li className="nav-item">
          <button
            className={`nav-link ${activeTab === "systemSettings" ? "active" : ""
              }`}
        ...
        <li className="nav-item">
          <button
            className={`nav-link ${activeTab === "communicationSettings" ? "active" : ""
              }`}
        ...
        <li className="nav-item">
          <button
            className={`nav-link ${activeTab === "securitySettings" ? "active" : ""
              }`}
